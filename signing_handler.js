    ...
    $$: [
      { $tag: '.form-group', $$: [
        ...
        { $tag: 'textarea#tansaction_json.form-control',
          ...
          rows: 15,
          $update(){ this.$text = JSON.stringify(this._transaction_json, true, '  ') }
        },
      ]},
      { $tag: 'button.btn.btn-default.btn-block',
        $text: 'Load example transaction',
        onclick(){ this._transaction_json = exampleTransactionJson() }
      },
...
function exampleTransactionJson(){
	...
	Device seed: 'custodian popup test'
		...
		multisig:
			...
			path: '0/1/2/3'
			root_extended_keys:
				one: tpubD6NzVbkrYhZ4YSh1zgHc1L2fNXQmSZM1FEbVFpNGzK9J1GDuhRnfoLUA7Unzq44qHVviVtyKdfLjnJYiuTUTjYAJt6Un4svFfRPb7m6TvZk
				two: tpubD6NzVbkrYhZ4YBZEKjx5MH2yTFykDGATeS6qJDwRSCz8PZp7jSd3TZKZzAaWz1CZxrupuTyDue7L3gxC62CMSvxobDZN6tF1q29vd2WroBm
				three: tpubD6NzVbkrYhZ4WsV7xWDG6J3oCpgai4uAmEu9A4RDq3hsmEJjaBKiKtNvpSQGQ4zFyC5KXiVd3pc6Q7DqJNPZ7oQUY2vvHPzUPo1R4cUqPqk
			...
			{ hash: "c6199535c5e2bbf6437c87dfa4d8b6b16f6f9dae66eaa3205cb7044af974d6a8",
				...
				inputs: [
					{ prev_hash: "3ef7f7ce2ecac486c65cbfd23fae143b87d5425f5ea13e47e257814b836eff7c",
						prev_index: 1,
						sequence: 4294967295,
						script_sig: "7c94224a4e62aabf6da3360a62000d3c4e38d20" // HEX, not ASM.
					},
				],
				bin_outputs: [
					{ amount: 65000000,

                ...
                $$: [
                  ...
                  },
                  {
                    ...
                    onclick() {
                      switch(networkName) {
                        case 'rsk':
                          Transaction('rsk').signRskTransaction([44, 137, 0, 0], this._toRskAddress, this._fromRskAddress, 1, 10, this._rskAmount, null)
                          break
                        case 'rsk_testnet':
                          Transaction('rsk_testnet').signRskTransaction([44, 37310, 0, 0], this._toRskAddress, this._fromRskAddress, 1, 10, this._rskAmount, null)
                          break
                      }
                    }
                  }
